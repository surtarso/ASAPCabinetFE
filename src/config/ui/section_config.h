...
public:
    SectionConfig() {
        ...
        keyDisplayNames_["Internal"] = {
            ...
            {"exeDir", "Detected Executable Path"},
            {"indexPath", "Index Path"},
            {"mainDbPath", "Main Database Path"},
            {"mainCacheDir", "Main Cache Path"},
            {"previewCacheDir", "Editor Previews Cache Dir"},
            {"dmdStillImages", "Generated DMD Logos Path"},
            {"topperStillImages", "Generated Topper Logos Path"},
            {"defaultWheelImage", "Default Wheel Image"},
            {"vbsHashPath", "VBS Script Hashes File for Patching"},
            ...
            {"lbdbImgUrl", "Launchbox Image Link"},
            {"lbdbZipUrl", "Launchbox Database URL"},
            {"lbdbZipPath", "Launchbox DB Temp Path (zip)"},
